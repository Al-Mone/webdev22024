...
<body>
    <video autoplay muted loop class="video-bg">
        <source src="{{ asset('media/bg-vid.mp4') }}" type="video/mp4">
    ...
    <div class="container d-flex h-100 align-items-center justify-content-center">
        <div class="content">
            ...
            <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin suscipit tempor varius. Sed
                a tortor mauris.</p>
            <form action="{{ route('handleRedirect') }}" method="post">
                @csrf
